...
public class PersonalVocab {
    ...
    public PersonalVocab(Long id, String word, String reading, String meaning, String example, String exampleMeaning, LocalDateTime createdAt, User user, VocabFolder folder) {
        this.id = id;
        this.word = word;
    ...
    public static class PersonalVocabBuilder {
        ...
        public PersonalVocab build() {
            return new PersonalVocab(id, word, reading, meaning, example, exampleMeaning, createdAt, user, folder);
        }
    }
